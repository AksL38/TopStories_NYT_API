const url1 = 'https://api.nytimes.com/svc/topstories/v2/';
const url2 = '.json?api-key=3Yw8iGJCgGjY7xVmbUAb9kcpLm36ShLT';
const sections = ['home', 'world', 'politics', 'magazine', 'technology', 'science', 'health', 'sports', 'arts', 'fashion', 'food', 'travel'];
...
// Render home page
let horizontal = createDomElement('hr', document.body, [['style', '2px gray']])
